...
/**
 * This is the model class for table "hoatdonghoctap".
 *
 * The followings are the available columns in table 'hoatdonghoctap':
 * @property integer $mahdht
 ...
 */
class Hoatdonghoctap extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('tenhoatdong, ngaybatdau, ngayketthuc, mota, vaitro', 'required'),
			array('matk', 'numerical', 'integerOnly'=>true),
			array('tenhoatdong', 'length', 'max'=>50),
			array('ngaybatdau, ngayketthuc', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('mahdht, tenhoatdong, ngaybatdau, ngayketthuc, mota, vaitro, matk', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('mahdht',$this->mahdht);
	 ...
	 * @return Hoatdonghoctap the static model class
	 */
