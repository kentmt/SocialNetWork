 ...
 */
class Chuyennganh extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('chuyennganh', 'required'),
			array('chuyennganh', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('machuyennganh, chuyennganh', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Chuyennganh the static model class
	 */
