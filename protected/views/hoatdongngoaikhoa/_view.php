...
/* @var $data Hoatdongngoaikhoa */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('mahdnk')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->mahdnk), array('view', 'id'=>$data->mahdnk)); ?>
	<br />
